      ...
      >
        ...
        <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md z-10">
          ...
          <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <h2 class="text-lg font-bold text-gray-900">Approve Ticket</h2>
            <button
              @click="handleClose"
          ...
          <div class="px-6 py-5">
            <p class="text-sm text-gray-500 mb-4">
              Apakah Anda yakin ingin approve ticket ini?
            </p>
            ...
            <div>
              ...
              <textarea
                v-model="reason"
                rows="3"
                placeholder="Masukkan alasan approval (opsional)"
                class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-green-500 transition-colors resize-none"
              />
            </div>
          </div>
